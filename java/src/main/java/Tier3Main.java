...
//            .create("Solo Leveling", "A light Novel", new BigDecimal(12.50), 0,new Category(1, "Book"), 15, "Images/solo_leveling_vol1.jpg", "9781975319274", new ArrayList<>(Arrays.asList(new Author(1,"Chu", "Gong"))), "English", genres,
...
//        databaseManager.getBookDAOService()
//            .create("Pride and Prejudice", "A classic novel; Has too many movies", new BigDecimal(12), 0,new Category(1, "Book"), 25, "Images/pride_and_prejudice.jpg", "9780679783268", new ArrayList<>(Arrays.asList(new Author(2,"Jane", "Austen"))), "English", genres, LocalDate.of(1813, 1, 28));
